...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      <div
        className={`${jetbrains.className} text-white flex flex-col w-full max-w-5xl gap-4 uppercase text-whte`}
      >
        <h1 className="text-[36px] sm:text-[60px] md:text-[72px] lg:text-[96px] w-full leading-none flex justify-around">
          {breakWordIntoLetters('Victor Velozo')}
        </h1>
        <h2 className="text-[24px] sm:text-[36px] md:text-[60px] lg:text-[72px] w-full leading-none flex justify-around">
